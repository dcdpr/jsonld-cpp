...
public:
    ...
    static void performToRDFTestFromAlternateManifest(const std::string& testName, const std::string& manifestName) {
...
TEST_F(JsonLdProcessorToRDFTest, toRdf_t0133) {
    performToRDFTestFromManifest("#t0133");
}
...
TEST_F(JsonLdProcessorToRDFTest, toRdf_tc037) {
    performToRDFTestFromManifest("#tc037");
}

TEST_F(JsonLdProcessorToRDFTest, toRdf_tc038) {
    performToRDFTestFromManifest("#tc038");
}
...
TEST_F(JsonLdProcessorToRDFTest, DISABLED_toRdf_with_manifest) {
    ...
    std::string resource_dir = TEST_RESOURCE_DIR;
    ManifestLoader manifestLoader(resource_dir + "test_data/", "toRdf-manifest.jsonld");
